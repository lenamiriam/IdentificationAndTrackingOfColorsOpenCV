...
video = cv2.VideoCapture('cat_movie.avi')
...
result = cv2.VideoWriter('cat_processed_movie.avi', cv2.VideoWriter_fourcc(*'MJPG'), fps, size)
...
display_video('cat_processed_movie.avi')
